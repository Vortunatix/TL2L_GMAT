...
public class Rocket : MonoBehaviour {
    ...
    private protected float time; // multiplier for size of calcjlated steps
    private protected long globalScale; // global scaling factor for calculating the coordinates determining where to draw the sprites
    private protected float cameraScale; // current orthographic scale of the camera
    ...
    /* references and states for visualisation 
    public bool forceVisualisationState;
    public float forceVisualisationScale;
    public GameObject arrowsForce;
    public Arrow arrowForce;
    public Arrow arrowForceX;
    public Arrow arrowForceY;
    public bool velocityVisualisationState;
    public float velocityVisualisationScale;
    public GameObject arrowsVelocity;
    public Arrow arrowVelocity;
    public Arrow arrowVelocityX;
    public Arrow arrowVelocityY;
    */
    ...
    public void UpdatePosition() { // move the gameObject to the correct position 
        ...
        //if(planetSystem.GetComponent<PlanetSystem>().timeScale != 0f)
        //arrowForce.SetStartPosition(gameObject.transform.localPosition);
        //arrowForce.SetEndPosition(new Vector3((float)(position.x + force.x) * forceVisualisationScale, (float)(position.y + force.y) * forceVisualisationScale, 0f));
    ...
    /*
    public void ToggleForceVisualisation() {
        forceVisualisationState = !forceVisualisationState;
        arrowsForce.SetActive(forceVisualisationState);
    }

    public void ToggleVelocityVisualisation() {
        velocityVisualisationState = !velocityVisualisationState;
        arrowsVelocity.SetActive(velocityVisualisationState);
    }*/
